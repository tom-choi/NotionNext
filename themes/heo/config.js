const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '歡迎加入我的遊戲社區', url: 'https://discord.gg/Ua2njAfQCN' },
    { title: '歡迎訪問我的GitHub主頁', url: 'https://github.com/tom-choi' }
  ],
  ...
  HEO_HERO_TITLE_3: 'Macau SMP',
  HEO_HERO_TITLE_4: '地球不爆炸',
  HEO_HERO_TITLE_5: 'Macau SMP 不休息',
  ...
  HEO_INFO_CARD_URL: 'https://github.com/tom-choi', // 个人资料底部按钮链接

  // 用户技能图标
  HEO_GROUP_ICONS: [
    {
      title_1: 'Minecraft',
      img_1: 'https://preview.redd.it/avjal33hpqo61.png?width=512&format=png&auto=webp&s=b652d83347448df74c8ba61c17b322e686ee32a4',
      color_1: '#989bf8',
      title_2: 'Sketch',
  ...
  HEO_SOCIAL_CARD_URL: 'https://discord.gg/Ua2njAfQCN',
